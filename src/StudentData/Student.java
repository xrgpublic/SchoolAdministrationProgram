/*
 * This file creates student object
 */
...
public class Student {
    ...
    private void getGradeLevel(){ 
        ...
        //Loop ends when the grade level entered is between 1 and 5 inclusive 
        while(loopController == false){
            ...
            try{
                ...
                //Makes sure grade level is between 1st grade and 5th grade
                if(gradeLevelNumber > 0 && gradeLevelNumber < 6){
                   loopController = true;
                }
            }
